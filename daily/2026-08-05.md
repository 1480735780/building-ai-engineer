...
<!-- 导出说明：2026-08-05 从飞书导出。图片去重后 56 张复用 daily/图片和附件/，2 张新增存于 ../assets/。
     缺失：image 55.png、image 56.png 在飞书导出中未包含，引用保留但链接失效。 -->
...
在[举例1中](https://iip91ea6zp9.feishu.cn/docx/GkXmdfPheoIUjZxarqDcDDL3nRh#doxcnd4vKUTjk1hRKzcdPuwR2Yc)，如果defer=True会发生什么？
...
1. **Runtime 将图的执行分解为多个Superstep**。也就是我们上面章节谈到的[Superstep的底层实现三步骤](https://iip91ea6zp9.feishu.cn/docx/GkXmdfPheoIUjZxarqDcDDL3nRh#doxcn2pBWijOQM0YOndZp3wAQKP)。
