...
<!-- 导出说明：2026-08-06 从飞书导出。图片去重后 60 张复用 daily/图片和附件/ 或 assets/，4 张新增存于 ../assets/。 -->
...
在粗排（Bi\-Encoder）阶段完成 Top\-50/100 候选集的快速划定后，精排（Cross\-Encoder）阶段的唯一使命是**精细化对齐语义，剔除假阳性（False Positives）与硬负样本（Hard Negatives）**。
